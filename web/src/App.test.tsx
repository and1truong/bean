...
describe('public rendering',()=>{
  ...
  it('applies typed theme and renders metric timeline and declared search',async()=>{
	const fetchMock=vi.fn(async(input:string|URL|Request)=>{
	  ...
	  if(path.includes('_block=timeline'))return response({data:[{id:'a',name:'Jamie Chen',note:'Interview scheduled',stage:'interview',applied_at:'2026-08-31T10:00:00Z'}],nextCursor:''})
