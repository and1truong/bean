...
export function Explore(){
  ...
  const previewCandidate=useMemo(()=>({name:viewName,spec,...(mode==='records'&&search?{search}:{}),filter:filterName&&filterValue?{[filterName]:filterValue}:{},limit:25}),[viewName,spec,mode,search,filterName,filterValue])
