...
export type Manifest={appId:string;releaseId:string;version:number;entities:Record<string,Entity>;views:Record<string,unknown>;actions:Record<string,Action>;webforms:Record<string,{Name:string;Elements:FormElement[];Steps?:string[][];Confirmation?:string}>;pages:Record<string,unknown>;localRegistration?:{Action:string};renderTree?:Node}
