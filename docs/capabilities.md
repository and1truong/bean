...
| Hierarchical Menu contracts | AppIR v13 stores bounded workspace hierarchy, static Page/View targets, owner scope, and Entity record destinations | active | AppIR/compiler/schema/capabilities/inspection/diff contracts; runtime placement work pending |
