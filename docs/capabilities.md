# Bean v0.5 capability matrix

`complete` means the v0.5 compiler/runtime pair has direct executable evidence. Bean remains alpha software and the limits below are part of the contract.
