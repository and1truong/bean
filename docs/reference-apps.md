...
- `presentation`: a seventeen-frame, eight-chapter introduction to Bean using horizontal `next` and vertical `down` Sequence navigation, semantic content and Tabs Blocks, speaker notes, deterministic capability data, and a real grouped View/chart.
